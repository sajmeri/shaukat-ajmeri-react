...
<div className={styles.Document}>
  <div className={styles.maincontent}>    
      ...
      <div>
          <h2>Special deal - order your copy today</h2>
         ...
         <hr className={styles.spacing} />
          ...
          <h2>‘Inspiring and provocative novel’</h2>
 ...
 <h2>Foreword by Islmail K. Poonawala</h2>
  ...
  <p><strong>Rate and review it on <a target="_blank" href="https://www.goodreads.com/book/show/44334120-keepers-of-the-faith">Goodreads</a></strong> | <strong>Discuss it on <a target="_blank" href="https://www.facebook.com/keepersofthefaith2020/">Facebook</a></strong></p>
        <p>Please help promote the book on your social media and reach out to readers across different cultures and communities. It is a book with an important message, and  you can help spread the word. Many thanks.</p>
    </div>
